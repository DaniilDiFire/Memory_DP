...
from scripts.DBEngine import DBEngine
from scripts.ToDoWidget import ToDoWidget
...
class MainWindow(QWidget):
    def __init__(self):
        ...
        self.setWindowIcon(QIcon(os.path.join(path, "image", 'icon.ico')))
    ...
    def initUI(self):
        ...
        self.gridLayout.addWidget(self.status_box, 0, 4, 1, 2)
        ...
        self.new_task_btn = QPushButton(text="Добавить")
        ...
        self.delete_btn = QPushButton(text="Удалить")
        self.delete_btn.setMinimumSize(QtCore.QSize(100, 50))
    ...
    def save_changes(self):
        self.DB.update_data(
            [self.listWidget.itemWidget(self.listWidget.item(i)).task for i in range(self.listWidget.count())],
            mode="a")
